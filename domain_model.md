...
- После идентификации клента происходит привязка к его заказу по параметру **Код заказа** который называет клиент при обращении. Здесь действет логика поиска заказа аналогичная используемой для клиента. 
